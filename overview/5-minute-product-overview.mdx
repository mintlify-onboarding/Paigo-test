...
<CardGroup cols={2}>
  <Card title="Various pricing structure" icon="square-1" color="#3f76dd">
  pay-as-you-go, subscription tier, flat rate, or hybrid.
  </Card>
  <Card title="Pricing add-on" icon="square-2" color="#3f76dd">
  usage entitlement, overage charge, free trial, discount
  </Card>
</CardGroup>

<Card title="B2B sales deal" icon="square-3" color="#3f76dd">
...
<CardGroup cols={2}>
  <Card title="Total cost" icon="square-1" color="#3f76dd">
  </Card>
  <Card title="Variable cost as designated by usage dimensions" icon="square-2" color="#3f76dd">
  </Card>
  <Card title="Fixed cost" icon="square-3" color="#3f76dd">
  </Card>
  <Card title="Cost breakdown" icon="square-4" color="#3f76dd">
  </Card>
</CardGroup>

<Card title="Unit cost" icon="square-5" color="#3f76dd">
</Card>
