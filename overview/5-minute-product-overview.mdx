...
<CardGroup cols={2}>
  <Card title="Various pricing structure" icon="list-tree" color="#3f76dd">
  pay-as-you-go, subscription tier, flat rate, or hybrid.
  </Card>
  <Card title="Pricing add-on" icon="plus" color="#3f76dd">
  usage entitlement, overage charge, free trial, discount
  </Card>
</CardGroup>

<Card title="B2B sales deal" icon="comments-dollar" color="#3f76dd">
...
<CardGroup cols={2}>
  <Card title="Total cost" icon="calculator" color="#3f76dd">
  </Card>
  <Card title="Variable cost as designated by usage dimensions" icon="wave-sine" color="#3f76dd">
  </Card>
  <Card title="Fixed cost" icon="lock" color="#3f76dd">
  </Card>
  <Card title="Cost breakdown" icon="file" color="#3f76dd">
  </Card>
</CardGroup>

<Card title="Unit cost" icon="cube" color="#3f76dd">
</Card>
