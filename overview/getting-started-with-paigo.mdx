...
<CardGroup cols={2}>
  <Card title="Billing Setup" icon="square-1" color="#3f76dd">
  </Card>
  <Card title="Report usage data" icon="square-2" color="#3f76dd">
  </Card>
</CardGroup>

<Card title="Use the data" icon="square-3" color="#3f76dd">
</Card>
